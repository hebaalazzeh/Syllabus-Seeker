...
import { Star, Download, FileText, Calendar, School, User, Search } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-8 space-y-6">
      {results.map((syllabus) => (
        <div 
          key={syllabus.id} 
          className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all duration-200 hover:scale-[1.02]"
        >
                ...
                {syllabus.fileUrl && (
                  <a
                    ...
                    className="flex items-center gap-2 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300
                             bg-blue-50 dark:bg-blue-900/30 px-4 py-2 rounded-lg transition-colors"
                  >
                ...
                {syllabus.textContent && (
                  <button
                    className="flex items-center gap-2 text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300
                             bg-green-50 dark:bg-green-900/30 px-4 py-2 rounded-lg transition-colors"
